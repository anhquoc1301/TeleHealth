...
class MeetingGuest(models.Model):
    id = models.BigAutoField(primary_key=True, unique=True)
    meeting = models.ForeignKey(Meeting, on_delete=models.CASCADE, related_name='meeting_guest')
    meeting_guest = models.ForeignKey(User, on_delete=models.CASCADE, related_name='meeting_guest')
